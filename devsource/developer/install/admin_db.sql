...
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户端-用户信息' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of admin_account
-- ----------------------------
INSERT INTO `admin_account` VALUES (1, 1, 3, 'gofly', '51803771efab2e287483984bdb2a1e8b', '371721', '管理员', 'gofly后台', '/resource/uploads/20251116/localdea0f1kgir4c9dyazs.png', '88422345', '18988274072', '504500934@qq.com', '', 1763283171, 0, 0, '对的', '昆明', '开发测试账号', 'GoFLy科技', '', 'chaoyang', 2, '2025-05-15 23:12:19', '2024-02-05 15:28:03', '2025-11-16 17:28:06', '2024-12-19 13:31:33');
...
CREATE TABLE `admin_attachment`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 44 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'admin附件管理' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of admin_attachment
-- ----------------------------
INSERT INTO `admin_attachment` VALUES (11, 0, 0, 1, 0, '', '', '', '', 0, 0, '', '', 'local', '', '新建文件夹', '', '', 0, 1, 0, 11, NULL, NULL);
INSERT INTO `admin_attachment` VALUES (28, 0, 0, 1, 0, '', '', '', '', 0, 0, '', '', 'local', '', '新建文件夹1', '', '', 0, 1, 0, 28, '2024-05-20 22:46:55', '2024-05-20 22:46:55');
INSERT INTO `admin_attachment` VALUES (43, 0, 0, 0, 0, '/resource/uploads/20251116/localdea0f1kgir4c9dyazs.png', '', '', '', 0, 39625, 'image/png', '', 'local', '1a9b5896d090e694a9aca8c1a76515f6', 'gofly-图标2', 'gofly-图标2.png', '', 0, 0, 0, 43, '0000-00-00 00:00:00', '2025-11-16 17:25:47');
...
CREATE TABLE `admin_auth_role`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '权限分组' ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `common_picture` VALUES (9, 1, 2, 8, 'sw1.jpg', '管理技术', 0, '/resource/uploads/20251116/localdea1f8clcgo49pcsk6.png', '', '', 25384, 'image/jpeg', '/dataDB/project/go/gofly_singleresource\\uploads\\20230609\\c895e724853152e06b5915f046348808.jpg', '', '8a81b3c0d0f346d7a36a4573e7196408', 0, '2024-02-05 15:35:59');
INSERT INTO `common_picture` VALUES (10, 1, 24, 6, '信息.png', '微服务化', 1, '/resource/uploads/20251116/localdea1e3z4lqjkf5vdhb.png', '', '', 65892, 'image/png', '/dataDB/project/go/gofly_singleresource\\uploads\\20230609\\46e5cc40453791e1db8c0e25a1c8ff9c.png', '', 'd58b80c230362875af642143b6bd3a70', 0, '2024-02-05 15:35:59');
