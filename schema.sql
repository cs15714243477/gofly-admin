...
CREATE TABLE `business_properties` (
  ...
  `video_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '房源视频(单个URL)',
  `allow_image_download` tinyint(1) NOT NULL DEFAULT 1 COMMENT '图片是否允许下载:0否,1是',
  `allow_video_download` tinyint(1) NOT NULL DEFAULT 1 COMMENT '视频是否允许下载:0否,1是',
