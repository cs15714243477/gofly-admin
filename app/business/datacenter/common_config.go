...
func (api *Common_config) GetConfig(c *gf.GinCtx) {
	...
	gf.Success().SetMsg("获取配置").SetData(gf.Map{"showfilesize": showfilesize,
		"fileSize": fileSize, "vueobjroot": appConf_arr["vueobjroot"], "loginCaptcha": appConf_arr["loginCaptcha"],
