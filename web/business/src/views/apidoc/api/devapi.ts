...
enum Api {
    getList = '/apidoc/devapi/getList',
    getGroup = '/apidoc/devapi/getGroup',
    getDBField = '/apidoc/devapi/getDBField',
    getRoutes = '/apidoc/devapi/getRoutes',
    getModel = '/apidoc/devapi/getModel',
    getTablelist = '/apidoc/devapi/getTablelist',
    save = '/apidoc/devapi/save',
    del = '/apidoc/devapi/del',
}
