                      ...
                      <div>
                        ...
                        <div class="titlebox">
                          <div class="edit_title" title="点击可编辑文件名称">
                            <a-input v-model="iten.title" size="mini" placeholder="输入名称" :readonly="iten.is_common==1" style=" padding: 0;" @change="onChangFile" @pressEnter="(e:any)=>{onUpFile(iten.id,e)}" @blur="(e:any)=>{onUpFile(iten.id,e)}" :bordered="false"/> 
                          </div>
                        </div>
                      </div>
                    </div>
