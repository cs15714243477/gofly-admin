...
enum Api {
    getList = '/datacenter/logininfo/getList',
    getContent= '/datacenter/logininfo/getContent',
    save = '/datacenter/logininfo/save',
    upStatus = '/datacenter/logininfo/upStatus',
    del = '/datacenter/logininfo/del',
}
