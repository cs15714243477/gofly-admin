...
<script lang="ts" setup>
  ...
  //恢复设置
  const handleReset = () => {
    localStorage.setItem("adminsettingsval", JSON.stringify(defaultSettings));
    localStorage.removeItem("adminsettingsval")
  ...
  const handleSaveSettings = async () => {
    ...
    localStorage.setItem("adminsettingsval", JSON.stringify(defaultSetData.value));
