    ...
    <page-card breadcrumb :isFullscreen="isFullscreen">
      <div class="flexbox">
        <div class="menu flexcolumn">
          ...
          <div class="tablebox">
            <a-table :data="nenudata" @row-click="handleClickMenu" :row-class="(record:any)=>selectedKeys.includes(record.id)?'arco-table-tr-checked':''" :scroll="{ y: '100%'}" :pagination="false" :bordered="{wrapper: true, cell: true}" style="margin-top: 10px">
              <template #columns>
        ...
        <div class="custom-full-table">
          <div class="table-toolbar flex flex-between" style="padding: 0px 5px 5px 5px;">
            <div class="left">
              <a-space>
