  ...
  <div class="container">
    <page-card breadcrumb scrollPage :isFullscreen="isFullscreen">
      <a-row style="margin-bottom: 10px">
        <a-col :span="16">
           <div>
            此项菜单是业务端菜单与business端系统设置的菜单相同，两边数据同步，如果项目已经发布可以已经使business的隐藏菜单管理，可以在这里配置business端菜单。拖拽可修改同级顺序，跨不同层级请进入编辑页面修改。
           </div>
        </a-col>
        <a-col
          :span="8"
...
<script lang="ts" setup>
  ...
  import { getList,upStatus,del} from '@/api/business/bizrule';
